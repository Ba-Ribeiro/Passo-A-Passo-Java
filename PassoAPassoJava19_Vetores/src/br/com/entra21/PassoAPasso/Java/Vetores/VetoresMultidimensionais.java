...
public class VetoresMultidimensionais {
	...
	public static void main(String[] args) {
		...
		double[]x=new double[5]; //especificar o tipo de data que o vetor vai armazenar colocaria [] que indica que está fazendo um vetor daria um nome x,
	...
	for(int i =0; i<y.length; ++i) {// variavel i que inicia com o valor de 0, 
									//depois limita a condição do ciclo for ao tamanho do vetor e a cada execução do ciclo
									//aumento 1 a variavel i.
		
	for (int j = 0; j<y[i].length;++j); { // vamos criar uma outra variavel j. Enquanto j for menor que vetor j na posição i. length onde buscou o tamanhode x88
