...
public class Main {
	...
	public static void main(String[] args) {
		...
		// verificar quem está a cima e quem está abaixo da média

		// criar um unico membro que consegue armazenar diversos valores decimais;

		int numAlunos = 5; //2°Passo: quando for criar um vetor é possivel especificar manualmente o tamanho do seu
		...
		// logo conseguiria armazenar até 50 notas
		
		//3° Passo: Informar os valores dos membros do vetor
		//Em um vetor com 5 posições temos 5 indices que iniciam a contagem no zero
